...
const Navbar = () => {
  return (
    <div className="flex items-center justify-around p-3 bg-gray-100 text-blue-900 gap-10">
      <img src="/images/MakaTalkLogo.svg" alt="Logo" className="h-12 w-auto ml-5 justify-start" /> {/* Logo aligned to the extreme left */}
