...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between p-3 bg-gray-100 text-blue-900">
      <img src="/images/MakaTalkLogo.svg" alt="Logo" className="h-12 w-auto ml-5 justify-center" /> {/* Logo aligned to the extreme left */}
